...
function group_daily() {
  ...
  if (document.getElementById('group_daily').style.background == "white") {
    //console.log(document.getElementById('group_daily').style.background);
    document.getElementById('group_daily').style.background = "#FF8F00";
    document.getElementById('1').style.background = "#FF8F00";
    document.getElementById('6').style.background = "#FF8F00";
    document.getElementById('11').style.background = "#FF8F00";
    ...
    document.getElementById('group_monthly').style.background = "white";
    document.getElementById('group_biWeekly').style.background = "white";
    document.getElementById('group_custom').style.color = "#FF8F00"
    document.getElementById('group_weekly').style.color = "#FF8F00"
    document.getElementById('group_monthly').style.color = "#FF8F00"
    document.getElementById('group_biWeekly').style.color = "#FF8F00"
    document.getElementById('2').style.color = "#FF8F00";
    document.getElementById('3').style.color = "#FF8F00";
    document.getElementById('4').style.color = "#FF8F00";
    document.getElementById('5').style.color = "#FF8F00";
    document.getElementById('7').style.color = "#FF8F00";
    document.getElementById('8').style.color = "#FF8F00";
    document.getElementById('9').style.color = "#FF8F00";
    document.getElementById('10').style.color = "#FF8F00";
    document.getElementById('12').style.color = "#FF8F00";
    document.getElementById('13').style.color = "#FF8F00";
    document.getElementById('14').style.color = "#FF8F00";
    document.getElementById('15').style.color = "#FF8F00";
    ...
    document.getElementById('group_daily').style.color = "#FF8F00"
    document.getElementById('1').style.color = "#FF8F00"
    document.getElementById('6').style.color = "#FF8F00"
    document.getElementById('11').style.color = "#FF8F00"
...
function group_weekly() {
  if (document.getElementById('group_weekly').style.background == "white") {
    document.getElementById('group_weekly').style.background = "#FF8F00";
    document.getElementById('2').style.background = "#FF8F00";
    document.getElementById('7').style.background = "#FF8F00";
    document.getElementById('12').style.background = "#FF8F00";
...
function group_biWeekly() {
  if (document.getElementById('group_biWeekly').style.background == "white") {
    document.getElementById('group_biWeekly').style.background = "#FF8F00"
    document.getElementById('3').style.background = "#FF8F00"
    document.getElementById('8').style.background = "#FF8F00"
    document.getElementById('13').style.background = "#FF8F00"
...
function group_monthly() {
  if (document.getElementById('group_monthly').style.background == "white") {
    document.getElementById('group_monthly').style.background = "#FF8F00"
    document.getElementById('4').style.background = "#FF8F00"
    document.getElementById('9').style.background = "#FF8F00"
    document.getElementById('14').style.background = "#FF8F00"
...
function group_custom() {
  if (document.getElementById('group_custom').style.background == "white") {
    document.getElementById('group_custom').style.background = "#FF8F00"
    document.getElementById('5').style.background = "#FF8F00"
    document.getElementById('10').style.background = "#FF8F00"
    document.getElementById('15').style.background = "#FF8F00"
...
function mom_daily() {
  ...
  document.getElementById('4').style.color = "#FF8F00"
  document.getElementById('5').style.color = "#FF8F00"
  if(document.getElementById('group_daily').style.background != "#FF8F00"){
    document.getElementById('group_custom').style.background = "white"
    document.getElementById('group_weekly').style.background = "white"
    document.getElementById('group_biWeekly').style.background = "white"
    document.getElementById('group_daily').style.background = "white"
...
function mom_weekly() {
  ...
  document.getElementById('4').style.color = "#FF8F00"
  document.getElementById('5').style.color = "#FF8F00"
  if(document.getElementById('group_weekly').style.background != "#FF8F00"){
    document.getElementById('group_custom').style.background = "white"
    document.getElementById('group_weekly').style.background = "white"
    document.getElementById('group_biWeekly').style.background = "white"
    document.getElementById('group_daily').style.background = "white"
...
function mom_biWeekly() {
  ...
  document.getElementById('4').style.color = "#FF8F00"
  document.getElementById('5').style.color = "#FF8F00"
  if(document.getElementById('group_biWeekly').style.background != "#FF8F00"){
    document.getElementById('group_custom').style.background = "white"
    document.getElementById('group_weekly').style.background = "white"
    document.getElementById('group_biWeekly').style.background = "white"
    document.getElementById('group_daily').style.background = "white"
...
function mom_monthly() {
  ...
  document.getElementById('1').style.color = "#FF8F00"
  document.getElementById('5').style.color = "#FF8F00"
  if(document.getElementById('group_monthly').style.background != "#FF8F00"){
    document.getElementById('group_custom').style.background = "white"
    document.getElementById('group_weekly').style.background = "white"
    document.getElementById('group_biWeekly').style.background = "white"
    document.getElementById('group_daily').style.background = "white"
...
function mom_custom() {
  ...
  document.getElementById('4').style.color = "#FF8F00"
  document.getElementById('1').style.color = "#FF8F00"
  if(document.getElementById('group_custom').style.background != "#FF8F00"){
    document.getElementById('group_custom').style.background = "white"
    document.getElementById('group_weekly').style.background = "white"
    document.getElementById('group_biWeekly').style.background = "white"
    document.getElementById('group_daily').style.background = "white"
...
function group2_daily() {
  ...
  if (document.getElementById('group2_daily').style.background == "white") {
    //console.log(document.getElementById('group_daily').style.background);
    document.getElementById('group2_daily').style.background = "#FF8F00";
    document.getElementById('16').style.background = "#FF8F00";
    document.getElementById('21').style.background = "#FF8F00";
    document.getElementById('26').style.background = "#FF8F00";
    ...
    document.getElementById('17').style.color = "#FF8F00";
    document.getElementById('18').style.color = "#FF8F00";
    document.getElementById('19').style.color = "#FF8F00";
    document.getElementById('20').style.color = "#FF8F00";
    document.getElementById('22').style.color = "#FF8F00";
    document.getElementById('23').style.color = "#FF8F00";
    document.getElementById('24').style.color = "#FF8F00";
    document.getElementById('25').style.color = "#FF8F00";
    document.getElementById('27').style.color = "#FF8F00";
    document.getElementById('28').style.color = "#FF8F00";
    document.getElementById('29').style.color = "#FF8F00";
    document.getElementById('30').style.color = "#FF8F00";
    document.getElementById('group2_custom').style.color = "#FF8F00";
    document.getElementById('group2_weekly').style.color = "#FF8F00";
    document.getElementById('group2_monthly').style.color = "#FF8F00";
    document.getElementById('group2_biWeekly').style.color = "#FF8F00";
    ...
    document.getElementById('group2_daily').style.color = "#FF8F00";
    document.getElementById('16').style.color = "#FF8F00";
    document.getElementById('21').style.color = "#FF8F00";
    document.getElementById('26').style.color = "#FF8F00";
...
function group2_weekly() {
  if (document.getElementById('group2_weekly').style.background == "white") {
    document.getElementById('group2_weekly').style.background = "#FF8F00";
    document.getElementById('17').style.background = "#FF8F00";
    document.getElementById('22').style.background = "#FF8F00";
    document.getElementById('27').style.background = "#FF8F00";
    document.getElementById('16').style.background = "white";
    document.getElementById('18').style.background = "white";
    document.getElementById('19').style.background = "white";
    document.getElementById('20').style.background = "white";
...
function group2_biWeekly() {
  if (document.getElementById('group2_biWeekly').style.background == "white") {
    document.getElementById('group2_biWeekly').style.background = "#FF8F00"
    document.getElementById('18').style.background = "#FF8F00"
    document.getElementById('23').style.background = "#FF8F00"
    document.getElementById('28').style.background = "#FF8F00"
    document.getElementById('16').style.background = "white"
    document.getElementById('17').style.background = "white"
    document.getElementById('19').style.background = "white"
    document.getElementById('20').style.background = "white"
...
function group2_monthly() {
  if (document.getElementById('group2_monthly').style.background == "white") {
    document.getElementById('group2_monthly').style.background = "#FF8F00"
    document.getElementById('19').style.background = "#FF8F00"
    document.getElementById('24').style.background = "#FF8F00"
    document.getElementById('29').style.background = "#FF8F00"
    document.getElementById('16').style.background = "white"
    document.getElementById('17').style.background = "white"
    document.getElementById('18').style.background = "white"
    document.getElementById('23').style.background = "white"
...
function group2_custom() {
  if (document.getElementById('group2_custom').style.background == "white") {
    document.getElementById('group2_custom').style.background = "#FF8F00"
    document.getElementById('20').style.background = "#FF8F00"
    document.getElementById('25').style.background = "#FF8F00"
    document.getElementById('30').style.background = "#FF8F00"
    document.getElementById('16').style.background = "white"
    document.getElementById('17').style.background = "white"
    document.getElementById('18').style.background = "white"
    document.getElementById('19').style.background = "white"
  ...
  function sara_daily() {
    ...
    document.getElementById('19').style.color = "#FF8F00"
    document.getElementById('20').style.color = "#FF8F00"
    if(document.getElementById('group2_daily').style.background != "#FF8F00"){
      document.getElementById('group2_custom').style.background = "white"
      document.getElementById('group2_weekly').style.background = "white"
      document.getElementById('group2_biWeekly').style.background = "white"
      document.getElementById('group2_daily').style.background = "white"
  ...
  function sara_weekly() {
    ...
    document.getElementById('19').style.color = "#FF8F00"
    document.getElementById('20').style.color = "#FF8F00"
    if(document.getElementById('group2_weekly').style.background != "#FF8F00"){
      document.getElementById('group2_custom').style.background = "white"
      document.getElementById('group2_weekly').style.background = "white"
      document.getElementById('group2_biWeekly').style.background = "white"
      document.getElementById('group2_daily').style.background = "white"
  ...
  function sara_biWeekly() {
    ...
    document.getElementById('19').style.color = "#FF8F00"
    document.getElementById('20').style.color = "#FF8F00"
    if(document.getElementById('group2_biWeekly').style.background != "#FF8F00"){
      document.getElementById('group2_custom').style.background = "white"
      document.getElementById('group2_weekly').style.background = "white"
      document.getElementById('group2_biWeekly').style.background = "white"
      document.getElementById('group2_daily').style.background = "white"
  ...
  function sara_monthly() {
    ...
    document.getElementById('16').style.color = "#FF8F00"
    document.getElementById('20').style.color = "#FF8F00"
    if(document.getElementById('group2_monthly').style.background != "#FF8F00"){
      document.getElementById('group2_custom').style.background = "white"
      document.getElementById('group2_weekly').style.background = "white"
      document.getElementById('group2_biWeekly').style.background = "white"
      document.getElementById('group2_daily').style.background = "white"
  ...
  function sara_custom() {
    ...
    document.getElementById('19').style.color = "#FF8F00"
    document.getElementById('16').style.color = "#FF8F00"
    if(document.getElementById('group2_custom').style.background != "#FF8F00"){
      document.getElementById('group2_custom').style.background = "white"
      document.getElementById('group2_weekly').style.background = "white"
      document.getElementById('group2_biWeekly').style.background = "white"
      document.getElementById('group2_daily').style.background = "white"
